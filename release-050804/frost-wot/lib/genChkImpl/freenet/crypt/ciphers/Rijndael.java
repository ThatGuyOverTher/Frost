...
public class Rijndael implements BlockCipher {
	...
	for (int i=0; i<400; i++) {
	    ...
	    System.out.println("KEY="+freenet.support.Fields.bytesToHex(KEY,0,kb));

	    System.out.println("PT="+freenet.support.Fields.bytesToHex(P,0,16));
	    ...
	    System.out.println("CT="+freenet.support.Fields.bytesToHex(C,0,16));
