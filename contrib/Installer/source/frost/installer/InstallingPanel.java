...
public class InstallingPanel extends JPanel {
	...
	private javax.swing.JPanel getBottomPanel() {
		if(bottomPanel == null) {
			...
			consGridBagConstraints3.insets = new java.awt.Insets(6,0,6,10);
	...
	void installApplication() {
		...
		try {
			URLConnection connection = jnlpRemoteLocation.openConnection();
			Object content = jnlpRemoteLocation.getContent();
