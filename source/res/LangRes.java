...
public class LangRes extends ListResourceBundle {
	...
	{"Waittime after each try (min):", "Waittime after each try (min):"},
	...
	{"Show board update visualization (on)", "Show board update visualization (on)"},
	{"Decode each segment immediately after its download", "Decode each segment immediately after its download"},
	{"Try to download all segments, even if one fails (on)", "Try to download all segments, even if one fails (on)"},
	{"Enable requesting of failed download files (on)", "Enable requesting of failed download files (on)"},
