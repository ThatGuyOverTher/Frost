...
public class HelpHTMLDocument extends HTMLDocument {
  ...
  /** Creates a new instance of HelpHTMLDocument 
  *
...
//    }
     ...
     * @return the reader used by the parser to load the document
     */
/*    HelpHTMLEditorKit.ParserCallback getReader(int pos, int popDepth,
					   int pushDepth,
					   HTML.Tag insertTag,
	...
	HelpHTMLReader reader = new HelpHTMLReader(pos, popDepth, pushDepth,
