...
public class UploadThread extends Thread
{
    ...
    /**Constructor*/
    public UploadThread(FrostUploadItemObject ulItem, SettingsClass config, int mode, LocalIdentity newMyId)
    {
        this(ulItem, config, mode, -1, newMyId);
    }
    public UploadThread(FrostUploadItemObject ulItem, SettingsClass config, int mode, int nextState, LocalIdentity newMyId)
    {
