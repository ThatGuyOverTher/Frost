...
//    }
    ...
    throws SQLException
    {
        ...
        if( mo.hasFileAttachments() ) {
            ...
            while(rs2.next()) {
                ...
                final FileAttachment fa = new FileAttachment(name, key, size, true);
                mo.addAttachment(fa);
            }
            rs2.close();
            p2.close();
     ...
     */
    public static LinkedList<FrostUnsentMessageObject> retrieveMessages(final AppLayerDatabase db,final List<Board> allBoards) throws SQLException {
        final LinkedList<FrostUnsentMessageObject> unsendMessages = new LinkedList<FrostUnsentMessageObject>();
        ...
        while( rs.next() ) {
            ...
            mo.setSendAfterTime(rs.getLong(ix++));
