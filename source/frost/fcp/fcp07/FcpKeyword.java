...
public final class FcpKeyword
{
    ...
    //FCP 2.0
    public final static int Identifier = 31;
    public final static int FCPVersion=32;
    public final static int Version=33;
    public final static int PutSuccessful=34;
    public final static int Metadata_ContentType=35;
    public final static int AllData=36;
    public final static int GetFailed=37;
    public final static int Fatal=38;
    public final static int Code=39;
    public final static int CodeDescription=40;
    public final static int SSKKeypair=41;
    public final static int InsertURI=42;
    public final static int RequestURI=43;
    public final static int URIGenerated=44;
    ...
    try
    {
        ...
        if (keyword.length() < fullString.length())
            ...
            longVal = Long.parseLong(number, 10);
            }
        else
            {
            longVal = -1;
    ...
    if (s.startsWith("AllData"))
    	...
    	return Code;
    else if (s.startsWith("CodeDescription"))
    ...
    else if (s.startsWith("GetFailed"))
    	return GetFailed;
    else if (s.startsWith("HopsToLive"))
        return HopsToLive;
    else if (s.startsWith("KeyCollision"))
        return KeyCollision;
    else if (s.startsWith("Identifier"))
    	return Identifier;
    else if (s.startsWith("InsertURI"))
    	return InsertURI;
        ...
        return Reason;
    else if (s.startsWith("RequestURI"))
    	return RequestURI;
        ...
        return Timeout;
    else if (s.startsWith("Metadata.ContentType"))
    	return Metadata_ContentType;
    else if (s.startsWith("SSKKeypair"))
    	return SSKKeypair;
    else
        return -1;
    }
