 ...
 */
public class FileListDatabaseTable {
    
//    fileinfo ->  1:n    sharerfileinfo   1:n    <- sharerinfo  
//    (unique per sha)    (1 per sharer and file)    (unique per sharer)
...
//    }
//
    private FrostFileListFileObject getFrostFileListFileObject(AppLayerDatabase db, long primkey) throws SQLException {
...
//    }
    ...
    private List<FrostFileListFileObjectOwner> getFrostFileListFileObjectOwnerList(AppLayerDatabase db, long refkey) throws SQLException {
        PreparedStatement ps = db.prepareStatement(
        ...
        while( rs.next() ) {
            ...
            FrostFileListFileObjectOwner ob = null;
            ob = new FrostFileListFileObjectOwner(name, owner, comment, keywords, rating, lastreceived, lastuploaded, fnKey);
...
*/        
        ...
        while( rs.next() ) {
            ...
            FrostFileListFileObject fo = getFrostFileListFileObject(db, refkey);
            if( fo == null ) {
