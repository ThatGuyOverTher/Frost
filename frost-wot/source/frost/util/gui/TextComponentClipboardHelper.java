 ...
 * @version $Revision$
 */
public class TextComponentClipboardHelper extends MouseAdapter 
										  implements ClipboardOwner, ActionListener {

	private static Logger logger = Logger.getLogger(TextComponentClipboardHelper.class.getName());
	 ...
	 * 
	 */
	public TextComponentClipboardHelper(JTextComponent textComponent, Language language) {
