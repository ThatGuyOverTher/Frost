...
public class TagsToScan {
  ...
  CITE 
  CODE 
  static HTML.Tag  COMMENT All comments are labeled with this tag.
  static HTML.Tag  CONTENT // All text content is labeled with this tag.
  static HTML.Tag  DD 
  static HTML.Tag  DFN 
  static HTML.Tag  DIR 
  static HTML.Tag  DIV 
...
onunload    BODY                %Script;	#IMPLIED	 	 	the document has been removed
  ...
  private static void LoadTagList() {
    if (tagList == null) {
      tagList = new Vector();
   ...
   */
  public static Object HasTagUri(HTML.Tag t) {
    LoadTagList();
    // return vector(
    return null;
  }
